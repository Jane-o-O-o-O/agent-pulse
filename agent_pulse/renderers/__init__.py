...
from .json_out import JsonRenderer

__all__ = ["TerminalRenderer", "JsonRenderer"]

# [2026-04-30] Refactor: simplified __init__ logic
class _BaseHandler:
...
# [2026-05-04] Fix: timeout not respected in __init__
...
# [2026-05-18] Refactor: simplified __init__ logic
class _BaseHandler:
    """Base handler with common functionality.
